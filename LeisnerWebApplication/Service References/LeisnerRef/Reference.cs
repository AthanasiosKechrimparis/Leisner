...
namespace LeisnerWebApplication.LeisnerRef {
    ...
    public interface IBWSService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBWSService/SendMessage", ReplyAction="http://tempuri.org/IBWSService/SendMessageResponse")]
        void SendMessage(string Messagtxt, System.DateTime senddate, string Tittle, int UserID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBWSService/SendMessage", ReplyAction="http://tempuri.org/IBWSService/SendMessageResponse")]
        System.Threading.Tasks.Task SendMessageAsync(string Messagtxt, System.DateTime senddate, string Tittle, int UserID);
    }
    ...
    public partial class BWSServiceClient : System.ServiceModel.ClientBase<LeisnerWebApplication.LeisnerRef.IBWSService>, LeisnerWebApplication.LeisnerRef.IBWSService {
        ...
        public void SendMessage(string Messagtxt, System.DateTime senddate, string Tittle, int UserID) {
            base.Channel.SendMessage(Messagtxt, senddate, Tittle, UserID);
        }
        
        public System.Threading.Tasks.Task SendMessageAsync(string Messagtxt, System.DateTime senddate, string Tittle, int UserID) {
            return base.Channel.SendMessageAsync(Messagtxt, senddate, Tittle, UserID);
        }
    }
}
